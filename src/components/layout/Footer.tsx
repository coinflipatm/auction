      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Specialized auction platform for tow vehicles, connecting buyers with quality vehicles from towing operations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/auctions" className="hover:text-yellow-400 transition-colors">
                  Browse Auctions
                </Link>
              </li>
              <li>
                <Link to="/how-it-works" className="hover:text-yellow-400 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/security" className="hover:text-yellow-400 transition-colors">
                  Security
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>123 Tow Lane, Vehicle City, VC 12345</span>
              </li>
